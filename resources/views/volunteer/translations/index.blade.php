...
<div class="bg-white rounded-lg shadow mb-6 p-4">
    <form method="GET" action="{{ route('volunteer.translations.index') }}" class="flex flex-wrap gap-4">
        ...
        <a href="{{ route('volunteer.translations.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-4 py-2 rounded-lg">
            Clear
        </a>
    </form>
</div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-sm text-gray-500">
                                    <i class="fas fa-robot text-blue-500"></i> Auto-generated
                                </div>
                            </div>
                        </div>
                    </td>
