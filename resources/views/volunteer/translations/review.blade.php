...
@section('content')
<div class="mb-4">
    <a href="{{ route('volunteer.translations.index') }}" class="text-blue-600 hover:text-blue-800">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4 text-sm text-gray-600">
                    ...
                    <span><i class="fas fa-robot text-blue-500"></i> Auto-generated</span>
                </div>
            </div>
        </div>
...
<!-- Split View: Original vs Translation -->
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="p-6">
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <a href="{{ $translation->solution->url }}" target="_blank" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('volunteer.translations.approve', $translation) }}" id="reviewForm">
            @csrf
            <div class="p-6">
                <div class="mb-4">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="content" rows="8" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('content', $translation->content) }}</textarea>
                    @error('content')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
...
<div id="rejectModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form method="POST" action="{{ route('volunteer.translations.reject', $translation) }}">
                @csrf
                <div class="mb-4">
