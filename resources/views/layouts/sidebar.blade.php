        ...
        <div class="glassmorphism rounded-2xl p-4 border border-white/10 h-full">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('assessment') }}"
                   class="flex items-center gap-3 px-3 py-2 rounded-xl text-white/80 hover:bg-white/10 hover:text-white transition {{ request()->routeIs('assessment') ? 'bg-white/10 text-white' : '' }}">
...
<div class="lg:hidden fixed bottom-0 inset-x-0 z-20">
    <div class="glassmorphism border-t border-white/10">
        <div class="grid grid-cols-5">
            ...
            <a href="{{ route('assessment') }}" class="py-3 text-center text-white/80 {{ request()->routeIs('assessment') ? 'bg-white/10 text-white' : '' }}">
