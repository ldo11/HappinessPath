            ...
            <div class="px-6 py-4 space-y-6">
                ...
                <div>
                    ...
                    <select name="spiritual_preference" id="spiritual_preference"
                        ...
                        <option value="buddhism" {{ old('spiritual_preference') == 'buddhism' ? 'selected' : '' }}>Buddhism</option>
                        <option value="christianity" {{ old('spiritual_preference') == 'christianity' ? 'selected' : '' }}>Christianity</option>
                        <option value="secular" {{ old('spiritual_preference') == 'secular' ? 'selected' : '' }}>Secular</option>
                    </select>
