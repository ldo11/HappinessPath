...
@section('page-title', 'Create Daily Mission')
    ...
    <div class="bg-white rounded-lg shadow">
        <form method="POST" action="{{ route('admin.daily-missions.store') }}">
            ...
            <div class="px-6 py-4 border-b">
                <h3 class="text-lg font-medium text-gray-900">Create Daily Mission</h3>
            </div>
                ...
                <div>
                    ...
                    <div class="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-2">
                        ...
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="is_body" value="1" class="rounded border-gray-300" @checked((bool) old('is_body'))>
                            <span>Body</span>
                        </label>

                        <input type="hidden" name="is_mind" value="0">
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="is_mind" value="1" class="rounded border-gray-300" @checked((bool) old('is_mind'))>
                            <span>Mind</span>
                        </label>

                        <input type="hidden" name="is_wisdom" value="0">
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="is_wisdom" value="1" class="rounded border-gray-300" @checked((bool) old('is_wisdom'))>
                            <span>Wisdom</span>
                        </label>
                    </div>
                </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t flex justify-end space-x-3">
                <a href="{{ route('admin.daily-missions.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">Cancel</a>
