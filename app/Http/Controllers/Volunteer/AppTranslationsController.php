...
class AppTranslationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($search !== '') {
            $translations = array_filter(
                $translations,
                fn ($value, $key) => str_contains(mb_strtolower($key), mb_strtolower($search))
        ...
        return view('volunteer.app-translations.index', [
            'locale' => $locale,
    ...
    public function upload(Request $request)
    {
        ...
        // Clear cached views/config so changes reflect immediately
        try {
        ...
        return redirect()->route('volunteer.app-translations.index', ['locale' => $locale])
